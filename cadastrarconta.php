...
if(isset($_POST['btn-save']))
{
 ...
 $sql_query = "INSERT INTO pagamento(descricao,valor,datadevencimento) VALUES('$descricao','$valor','$datadevencimento')";
 // consulta SQL para inserir dados em banco de dados
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='cadastrarconta.php';
  </script>
  <?php
 }
 else
...
?>
    ...
    <div class="panel panel-default">
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Cadastrar Conta</a>
        <div id="page-stats" class="panel-collapse panel-body collapse in">
            <form action="cadastrarconta.php" method="POST">
  	<div class="row">
  	  <div class="form-group col-md-4">
  	  	<label for="descricao">Descrição*</label>
  	  	<input type="text" class="form-control" name="descricao" required id="descricao" placeholder="">
  	  </div>
	  <div class="form-group col-md-4">
  	  	<label for="valor">Valor*</label>
  	  	<input type="text" class="form-control" name="valor" required id="valor" placeholder="">
  	  </div>
	  <div class="form-group col-md-4">
  	  	<label for="datadevencimento">Data de Vencimento*</label>
  	  	<input type="text" class="form-control" name="datadevencimento" required id="datadevencimento" placeholder="">
  	  </div>
	...
	<div class="row">
	  <div class="col-md-12">
	  	<button type="submit" name="btn-save" class="btn btn-primary fa fa-save"> Cadastrar</button>
                <a href="consultarconta.php" class="btn btn-primary fa fa-search"> Consultar</a>
