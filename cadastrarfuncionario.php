...
if(isset($_POST['btn-save']))
{
 ...
 // consulta SQL para inserir dados em banco de dados
 $sql_query = "INSERT INTO funcionario(nome,datadenascimento,cpf,telefone,celular,endereco,bairro,cidade,estado,email,senha,confirmarsenha) VALUES('$nome','$datadenascimento','$cpf','$telefone','$celular','$endereco','$bairro','$cidade','$estado','$email','$senha','$confirmarsenha')";
 // consulta SQL para inserir dados em banco de dados
 ...
 else
 {
  ?>
  <script type="text/javascript">
  alert('Ocorreu um erro durante a adição dos dados!');
  </script>
  <?php
 }
 // função de execução da consulta sql
...
?>
    ...
    <div class="panel panel-default">
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Cadastrar Funcionário</a>
        <div id="page-stats" class="panel-collapse panel-body collapse in">
            <form action="cadastrarfuncionario.php" method="POST">
  	<div class="row">
  	  <div class="form-group col-md-4">
  	  	<label for="nome">Nome*</label>
  	  	<input type="text" class="form-control" name="nome" required id="nome" placeholder="">
  	  </div>
	  <div class="form-group col-md-4">
  	  	<label for="datadenascimento">Data de Nascimento*</label>
  	  	<input type="text" class="form-control" name="datadenascimento" required id="datadenascimento" placeholder="">
  	  </div>
	  <div class="form-group col-md-4">
  	  	<label for="cpf">CPF*</label>
  	  	<input type="text" class="form-control" name="cpf" required id="cpf" placeholder="">
  	  </div>
	</div>
	...
	<div class="row">
  	  <div class="form-group col-md-3">
  	  	...
  	  	<input type="text" class="form-control" name="telefone" required id="telefone" placeholder="">
  	  </div>
	  <div class="form-group col-md-3">
  	  	<label for="celular">Celular</label>
  	  	<input type="text" class="form-control" name="celular" id="telefone" placeholder="">
  	  </div>
	  <div class="form-group col-md-3">
  	  	<label for="endereco">Endereço*</label>
  	  	<input type="text" class="form-control" name="endereco" required id="endereco" placeholder="">
  	  </div>
	  <div class="form-group col-md-3">
  	  	<label for="bairro">Bairro*</label>
  	  	<input type="text" class="form-control" name="bairro" required id="bairro" placeholder="">
  	  </div>
	</div>
	...
	<div class="row">
  	  <div class="form-group col-md-3">
  	  	...
  	  	<input type="text" class="form-control" name="cidade" required id="cidade" placeholder="">
  	  </div>        
  	  	...
  	  	<input type="password" class="form-control" name="senha" required id="senha" placeholder="">
  	  </div>
	  <div class="form-group col-md-3">
  	  	<label for="confirmarsenha">Confirmar Senha*</label>
  	  	<input type="password" class="form-control" name="confirmarsenha" required id="confirmarsenha" placeholder="">
  	  </div>  
  	  </div>
	<hr />
	...
	<div class="row">
	  <div class="col-md-12">
	  	<button type="submit" name="btn-save" class="btn btn-primary fa fa-save"> Cadastrar</button>
                <a href="consultarfuncionario.php" class="btn btn-primary fa fa-search"> Consultar</a>
		<a href="menuprincipal.php" type="reset" class="btn btn-primary fa fa-times"> Cancelar</a>
	  </div>
	</div>
