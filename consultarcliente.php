...
?>
    ...
    <div class="panel panel-default">
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Consultar Cliente</a>
   ...
   <div id="top" class="row">
 	  <div class="col-sm-6">
		  ...
		  <div class="input-group h2">
				<input name="cpf" class="form-control" id="cpf" type="text" placeholder="Buscar por nº de CPF">
...
function delete_id(id)
{
			...
			<thead>
				<tr>
					...
					<th class="actions">Ações</th>
								   ...
								   <?php
 $sql_query="SELECT * FROM cliente Limit 5";
 ...
 ?>
	...
	<div class="col-sm-1">
          <div align="left"><a href="cadastrarcliente.php" class="btn btn-primary fa fa-arrow-left"> Voltar</a></div>
		</div>
		</div>
