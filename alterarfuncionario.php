...
{
 $sql_query="SELECT * FROM funcionario WHERE id_funcionario=".$_GET['edit_id'];
...
if(isset($_POST['btn-update']))
{
 ...
 $sql_query = "UPDATE funcionario SET nome='$nome',datadenascimento='$datadenascimento',cpf='$cpf',telefone='$telefone',celular='$celular',endereco='$endereco',bairro='$bairro',cidade='$cidade',estado='$estado',email='$email',senha='$senha',confirmarsenha='$confirmarsenha' WHERE id_funcionario=".$_GET['edit_id'];
 // consulta SQL para atualizar dados em banco de dados
...
?>
    ...
    <div class="panel panel-default">
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Alterar Funcionário</a>
	...
	<div class="row">
  	  <div class="form-group col-md-3">
  	  	...
  	  	<input type="password" class="form-control" name="senha" value="<?php echo $fetched_row['senha']; ?>" placeholder="" required >
  	  </div>
	  <div class="form-group col-md-3">
  	  	<label for="confirmarsenha">Confirmar Senha*</label>
  	  	<input type="password" class="form-control" name="confirmarsenha" value="<?php echo $fetched_row['confirmarsenha']; ?>" placeholder="" required >
  	  </div>
  	  </div>
	<hr />
	...
	<div class="row">
	  <div class="col-md-12">
  		...
  		<a href="consultarfuncionario.php" type="reset" class="btn btn-primary fa fa-times"> Cancelar</a>
	  </div>
	</div>
