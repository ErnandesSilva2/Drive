...
?>
    ...
    <div class="panel panel-default">
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Consultar Conta</a>
...
function delete_id(id)
{
 ...
 ?>
		...
		<div class="col-sm-3">
          <div align="left"><a href="cadastrarconta.php" class="btn btn-primary pull-right h2">Voltar</a></div>
		</div>
	</div>
