...
{
 $sql_query="DELETE FROM pagamento WHERE id_pagamento=".$_GET['delete_id'];
...
?>
    ...
    <div class="panel panel-default">
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Resultado Financeiro</a>
...
function edt_id(id)
{
 if(('Deseja alterar esta conta?'))
 {
  window.location.href='alterarconta.php?edit_id='+id;
 }
}
function delete_id(id)
{
 ...
 {
  window.location.href='consultarconta.php?delete_id='+id;
 }
}
</script>
			...
			<thead>
				<tr>
					...
					<th>Data de Vencimento</th>
								   ...
								   <?php
 $sql_query="SELECT * FROM pagamento Limit 5";
 ...
 ?>
		...
		<div class="col-sm-3">
          <div align="left"><a href="menuprincipal.php" class="btn btn-primary ">Voltar</a></div>
		</div>
		<div class="col-sm-3">
          <div align="left"><a href="gerarpdffinanceiro.php" class="btn btn-primary fa fa-file-text"> Gerar PDF</a></div>
		</div>
	</div>
	</div> <!-- /#list -->
