...
{
 $sql_query="DELETE FROM cliente WHERE id_cliente=".$_GET['delete_id'];
...
?>
    ...
    <li data-popover="true" data-content="" rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-bar-chart-o"></i> Relatórios<i class="fa fa-collapse"></i></a></li>
    ...
    <div class="panel panel-default">
        ...
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Resultado Busca</a>
        <div id="page-stats" class="panel-collapse panel-body collapse in">
        
<script type="text/javascript">
function edt_id(id)
{
 if(('Deseja alterar este cliente?'))
 {
  window.location.href='alterarcliente.php?edit_id='+id;
 }
}
function delete_id(id)
{
 ...
 {
  window.location.href='consultarcliente.php?delete_id='+id;
 }
}
</script>	 
...
$consulta = mysql_query ("SELECT * FROM cliente WHERE cpf LIKE '$cpf'");

$resultado = mysql_fetch_assoc($consulta);
if (empty ($resultado)){
echo "<script>alert('Cliente não encontrado!')</script>";
echo "<script>location.href=('consultarcliente.php')</script>";
}
?>	
...
?>	
			...
			<tbody>
				<tr>
					...
					<td><?php echo"".$resultado['datadenascimento'].""; ?></td>
					...
					<td class="actions">
						...
						<a class="btn btn-primary btn-xs fa fa-pencil" href="javascript:edt_id('<?php echo $consulta[0]; ?>')"> Alterar</a>
						<a class="btn btn-danger btn-xs fa fa-trash-o"  href="javascript:delete_id('<?php echo"".$consulta[0].""; ?>')"> Excluir</a>
					</td>
				</tr>
...
<div class="col-sm-12"><hr/>
          <div align="left"><a href="consultarcliente.php" class="btn btn-primary fa fa-arrow-left"> Voltar</a></div>
		</div>
		</div>
		</div>
		</div>
