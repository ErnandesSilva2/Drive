...
if(isset($_POST['btn-save']))
{
 ...
 $sql_query = "INSERT INTO cliente(nome,datadenascimento,cpf,telefone,celular,endereco,bairro,cidade,estado,email) VALUES('$nome','$datadenascimento','$cpf','$telefone','$celular','$endereco','$bairro','$cidade','$estado','$email')";
 // consulta SQL para inserir dados em banco de dados
...
?>
    ...
    <div class="panel panel-default">
        <a href="#page-stats" class="panel-heading" data-toggle="collapse">Cadastrar Cliente</a>
	  ...
	  <div class="form-group col-md-4">
  	  	...
  	  	<input type="text" class="form-control" pattern="" title="" name="datadenascimento" required id="datadenascimento" placeholder="">
  	  </div>
	  <div class="form-group col-md-4">
  	  	<label for="cpf">CPF*</label>
  	  	<input type="text" class="form-control" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="Digite o CPF no formato nnn.nnn.nnn-nn" name="cpf" required id="cpf" placeholder="">
  	  </div>
	</div>
	...
	<div class="row">
	  <div class="col-md-12">
	  	<button type="submit" name="btn-save" class="btn btn-primary fa fa-save"> Cadastrar</button>
                <a href="consultarcliente.php" class="btn btn-primary fa fa-search"> Consultar</a>
